...
class SingleObjectTracker:
    def __init__(self,
        ...
        self.payload: Optional[Any] = payload0
    ...
    def active_tracks(self,
        ...
        for tracker in self.trackers:
            ...
            if cond1 and cond2 and cond3:
                tracks.append(Track(id=tracker.id, box=tracker.box(), score=tracker.score, class_id=tracker.class_id, payload=tracker.payload))
